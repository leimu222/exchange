 ...
 */
@Service
public class ContractCoinBizServiceImpl extends CommonService implements IContractCoinBizService {
	@Autowired
	...
	*/
	...
	public ContractCoin selectContractCoinById(Long id) {
		return contractCoinService.selectContractCoinById(id);
	}
	...
	*/
	...
	public List<ContractCoin> selectContractCoinList(ContractCoin contractCoin) {
		return contractCoinService.selectContractCoinList(contractCoin);
	}
	...
	*/
	...
	public int insertContractCoin(ContractCoin contractCoin) {
		return contractCoinService.insertContractCoin(contractCoin);
	}
	...
	*/
	...
	public int updateContractCoin(ContractCoin contractCoin) {
		return contractCoinService.updateContractCoin(contractCoin);
	}
	...
	*/
	...
	public int deleteContractCoinByIds(Long[] ids) {
		return contractCoinService.deleteContractCoinByIds(ids);
	}
	...
	*/
	...
	public int deleteContractCoinById(Long id) {
		return contractCoinService.deleteContractCoinById(id);
	}
