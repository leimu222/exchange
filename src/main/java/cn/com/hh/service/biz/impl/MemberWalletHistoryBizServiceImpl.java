 ...
 */
@Service
public class MemberWalletHistoryBizServiceImpl extends CommonService implements IMemberWalletHistoryBizService {
	@Autowired
	...
	*/
	...
	public MemberWalletHistory selectMemberWalletHistoryById(Long id) {
		return memberWalletHistoryService.selectMemberWalletHistoryById(id);
	}
	...
	*/
	...
	public List<MemberWalletHistory> selectMemberWalletHistoryList(MemberWalletHistory memberWalletHistory) {
		return memberWalletHistoryService.selectMemberWalletHistoryList(memberWalletHistory);
	}
	...
	*/
	...
	public int insertMemberWalletHistory(MemberWalletHistory memberWalletHistory) {
		return memberWalletHistoryService.insertMemberWalletHistory(memberWalletHistory);
	}
	...
	*/
	...
	public int updateMemberWalletHistory(MemberWalletHistory memberWalletHistory) {
		return memberWalletHistoryService.updateMemberWalletHistory(memberWalletHistory);
	}
	...
	*/
	...
	public int deleteMemberWalletHistoryByIds(Long[] ids) {
		return memberWalletHistoryService.deleteMemberWalletHistoryByIds(ids);
	}
	...
	*/
	...
	public int deleteMemberWalletHistoryById(Long id) {
		return memberWalletHistoryService.deleteMemberWalletHistoryById(id);
	}
