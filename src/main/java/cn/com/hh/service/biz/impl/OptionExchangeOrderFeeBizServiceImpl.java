 ...
 */
@Service
public class OptionExchangeOrderFeeBizServiceImpl extends CommonService implements IOptionExchangeOrderFeeBizService {
	@Autowired
	...
	*/
	...
	public OptionExchangeOrderFee selectOptionExchangeOrderFeeById(Long orderId) {
		return optionExchangeOrderFeeService.selectOptionExchangeOrderFeeById(orderId);
	}
	...
	*/
	...
	public List<OptionExchangeOrderFee> selectOptionExchangeOrderFeeList(OptionExchangeOrderFee optionExchangeOrderFee) {
		return optionExchangeOrderFeeService.selectOptionExchangeOrderFeeList(optionExchangeOrderFee);
	}
	...
	*/
	...
	public int insertOptionExchangeOrderFee(OptionExchangeOrderFee optionExchangeOrderFee) {
		return optionExchangeOrderFeeService.insertOptionExchangeOrderFee(optionExchangeOrderFee);
	}
	...
	*/
	...
	public int updateOptionExchangeOrderFee(OptionExchangeOrderFee optionExchangeOrderFee) {
		return optionExchangeOrderFeeService.updateOptionExchangeOrderFee(optionExchangeOrderFee);
	}
	...
	*/
	...
	public int deleteOptionExchangeOrderFeeByIds(Long[] orderIds) {
		return optionExchangeOrderFeeService.deleteOptionExchangeOrderFeeByIds(orderIds);
	}
	...
	*/
	...
	public int deleteOptionExchangeOrderFeeById(Long orderId) {
		return optionExchangeOrderFeeService.deleteOptionExchangeOrderFeeById(orderId);
	}
