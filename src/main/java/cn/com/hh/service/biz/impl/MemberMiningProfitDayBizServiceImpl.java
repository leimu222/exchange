 ...
 */
@Service
public class MemberMiningProfitDayBizServiceImpl extends CommonService implements IMemberMiningProfitDayBizService {
	@Autowired
	...
	*/
	...
	public MemberMiningProfitDay selectMemberMiningProfitDayById(Long id) {
		return memberMiningProfitDayService.selectMemberMiningProfitDayById(id);
	}
	...
	*/
	...
	public List<MemberMiningProfitDay> selectMemberMiningProfitDayList(MemberMiningProfitDay memberMiningProfitDay) {
		return memberMiningProfitDayService.selectMemberMiningProfitDayList(memberMiningProfitDay);
	}
	...
	*/
	...
	public int insertMemberMiningProfitDay(MemberMiningProfitDay memberMiningProfitDay) {
		return memberMiningProfitDayService.insertMemberMiningProfitDay(memberMiningProfitDay);
	}
	...
	*/
	...
	public int updateMemberMiningProfitDay(MemberMiningProfitDay memberMiningProfitDay) {
		return memberMiningProfitDayService.updateMemberMiningProfitDay(memberMiningProfitDay);
	}
	...
	*/
	...
	public int deleteMemberMiningProfitDayByIds(Long[] ids) {
		return memberMiningProfitDayService.deleteMemberMiningProfitDayByIds(ids);
	}
	...
	*/
	...
	public int deleteMemberMiningProfitDayById(Long id) {
		return memberMiningProfitDayService.deleteMemberMiningProfitDayById(id);
	}
