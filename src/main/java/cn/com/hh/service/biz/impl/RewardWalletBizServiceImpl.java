 ...
 */
@Service
public class RewardWalletBizServiceImpl extends CommonService implements IRewardWalletBizService {
	@Autowired
	...
	*/
	...
	public RewardWallet selectRewardWalletById(Long id) {
		return rewardWalletService.selectRewardWalletById(id);
	}
	...
	*/
	...
	public List<RewardWallet> selectRewardWalletList(RewardWallet rewardWallet) {
		return rewardWalletService.selectRewardWalletList(rewardWallet);
	}
	...
	*/
	...
	public int insertRewardWallet(RewardWallet rewardWallet) {
		return rewardWalletService.insertRewardWallet(rewardWallet);
	}
	...
	*/
	...
	public int updateRewardWallet(RewardWallet rewardWallet) {
		return rewardWalletService.updateRewardWallet(rewardWallet);
	}
	...
	*/
	...
	public int deleteRewardWalletByIds(Long[] ids) {
		return rewardWalletService.deleteRewardWalletByIds(ids);
	}
	...
	*/
	...
	public int deleteRewardWalletById(Long id) {
		return rewardWalletService.deleteRewardWalletById(id);
	}
