 ...
 */
@Service
public class RewardActivitySettingBizServiceImpl extends CommonService implements IRewardActivitySettingBizService {
	@Autowired
	...
	*/
	...
	public RewardActivitySetting selectRewardActivitySettingById(Long id) {
		return rewardActivitySettingService.selectRewardActivitySettingById(id);
	}
	...
	*/
	...
	public List<RewardActivitySetting> selectRewardActivitySettingList(RewardActivitySetting rewardActivitySetting) {
		return rewardActivitySettingService.selectRewardActivitySettingList(rewardActivitySetting);
	}
	...
	*/
	...
	public int insertRewardActivitySetting(RewardActivitySetting rewardActivitySetting) {
		return rewardActivitySettingService.insertRewardActivitySetting(rewardActivitySetting);
	}
	...
	*/
	...
	public int updateRewardActivitySetting(RewardActivitySetting rewardActivitySetting) {
		return rewardActivitySettingService.updateRewardActivitySetting(rewardActivitySetting);
	}
	...
	*/
	...
	public int deleteRewardActivitySettingByIds(Long[] ids) {
		return rewardActivitySettingService.deleteRewardActivitySettingByIds(ids);
	}
	...
	*/
	...
	public int deleteRewardActivitySettingById(Long id) {
		return rewardActivitySettingService.deleteRewardActivitySettingById(id);
	}
