 ...
 */
@Service
public class ContractStrategyExchangeConfigBizServiceImpl extends CommonService implements IContractStrategyExchangeConfigBizService {
	@Autowired
	...
	*/
	...
	public ContractStrategyExchangeConfig selectContractStrategyExchangeConfigById(Long id) {
		return contractStrategyExchangeConfigService.selectContractStrategyExchangeConfigById(id);
	}
	...
	*/
	...
	public List<ContractStrategyExchangeConfig> selectContractStrategyExchangeConfigList(ContractStrategyExchangeConfig contractStrategyExchangeConfig) {
		return contractStrategyExchangeConfigService.selectContractStrategyExchangeConfigList(contractStrategyExchangeConfig);
	}
	...
	*/
	...
	public int insertContractStrategyExchangeConfig(ContractStrategyExchangeConfig contractStrategyExchangeConfig) {
		return contractStrategyExchangeConfigService.insertContractStrategyExchangeConfig(contractStrategyExchangeConfig);
	}
	...
	*/
	...
	public int updateContractStrategyExchangeConfig(ContractStrategyExchangeConfig contractStrategyExchangeConfig) {
		return contractStrategyExchangeConfigService.updateContractStrategyExchangeConfig(contractStrategyExchangeConfig);
	}
	...
	*/
	...
	public int deleteContractStrategyExchangeConfigByIds(Long[] ids) {
		return contractStrategyExchangeConfigService.deleteContractStrategyExchangeConfigByIds(ids);
	}
	...
	*/
	...
	public int deleteContractStrategyExchangeConfigById(Long id) {
		return contractStrategyExchangeConfigService.deleteContractStrategyExchangeConfigById(id);
	}
