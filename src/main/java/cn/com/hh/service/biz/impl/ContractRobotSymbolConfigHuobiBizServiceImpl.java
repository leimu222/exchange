 ...
 */
@Service
public class ContractRobotSymbolConfigHuobiBizServiceImpl extends CommonService implements IContractRobotSymbolConfigHuobiBizService {
	@Autowired
	...
	*/
	...
	public ContractRobotSymbolConfigHuobi selectContractRobotSymbolConfigHuobiById(String symbol) {
		return contractRobotSymbolConfigHuobiService.selectContractRobotSymbolConfigHuobiById(symbol);
	}
	...
	*/
	...
	public List<ContractRobotSymbolConfigHuobi> selectContractRobotSymbolConfigHuobiList(ContractRobotSymbolConfigHuobi contractRobotSymbolConfigHuobi) {
		return contractRobotSymbolConfigHuobiService.selectContractRobotSymbolConfigHuobiList(contractRobotSymbolConfigHuobi);
	}
	...
	*/
	...
	public int insertContractRobotSymbolConfigHuobi(ContractRobotSymbolConfigHuobi contractRobotSymbolConfigHuobi) {
		return contractRobotSymbolConfigHuobiService.insertContractRobotSymbolConfigHuobi(contractRobotSymbolConfigHuobi);
	}
	...
	*/
	...
	public int updateContractRobotSymbolConfigHuobi(ContractRobotSymbolConfigHuobi contractRobotSymbolConfigHuobi) {
		return contractRobotSymbolConfigHuobiService.updateContractRobotSymbolConfigHuobi(contractRobotSymbolConfigHuobi);
	}
	...
	*/
	...
	public int deleteContractRobotSymbolConfigHuobiByIds(String[] symbols) {
		return contractRobotSymbolConfigHuobiService.deleteContractRobotSymbolConfigHuobiByIds(symbols);
	}
	...
	*/
	...
	public int deleteContractRobotSymbolConfigHuobiById(String symbol) {
		return contractRobotSymbolConfigHuobiService.deleteContractRobotSymbolConfigHuobiById(symbol);
	}
