 ...
 * Description: [releaseBiz服务实现]
 */
@Service
public class ReleaseBalanceBizServiceImpl extends CommonService implements IReleaseBalanceBizService {
	@Autowired
	...
	*/
	...
	public ReleaseBalance selectReleaseBalanceById(Long id) {
		return releaseBalanceService.selectReleaseBalanceById(id);
	}
	...
	*/
	...
	public List<ReleaseBalance> selectReleaseBalanceList(ReleaseBalance releaseBalance) {
		return releaseBalanceService.selectReleaseBalanceList(releaseBalance);
	}
	...
	*/
	...
	public int insertReleaseBalance(ReleaseBalance releaseBalance) {
		return releaseBalanceService.insertReleaseBalance(releaseBalance);
	}
	...
	*/
	...
	public int updateReleaseBalance(ReleaseBalance releaseBalance) {
		return releaseBalanceService.updateReleaseBalance(releaseBalance);
	}
	...
	*/
	...
	public int deleteReleaseBalanceByIds(Long[] ids) {
		return releaseBalanceService.deleteReleaseBalanceByIds(ids);
	}
	...
	*/
	...
	public int deleteReleaseBalanceById(Long id) {
		return releaseBalanceService.deleteReleaseBalanceById(id);
	}
