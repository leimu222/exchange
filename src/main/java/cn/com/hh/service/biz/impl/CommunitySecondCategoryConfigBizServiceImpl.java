 ...
 */
@Service
public class CommunitySecondCategoryConfigBizServiceImpl extends CommonService implements ICommunitySecondCategoryConfigBizService {
	@Autowired
	...
	*/
	...
	public CommunitySecondCategoryConfig selectCommunitySecondCategoryConfigById(String id) {
		return communitySecondCategoryConfigService.selectCommunitySecondCategoryConfigById(id);
	}
	...
	*/
	...
	public List<CommunitySecondCategoryConfig> selectCommunitySecondCategoryConfigList(CommunitySecondCategoryConfig communitySecondCategoryConfig) {
		return communitySecondCategoryConfigService.selectCommunitySecondCategoryConfigList(communitySecondCategoryConfig);
	}
	...
	*/
	...
	public int insertCommunitySecondCategoryConfig(CommunitySecondCategoryConfig communitySecondCategoryConfig) {
		return communitySecondCategoryConfigService.insertCommunitySecondCategoryConfig(communitySecondCategoryConfig);
	}
	...
	*/
	...
	public int updateCommunitySecondCategoryConfig(CommunitySecondCategoryConfig communitySecondCategoryConfig) {
		return communitySecondCategoryConfigService.updateCommunitySecondCategoryConfig(communitySecondCategoryConfig);
	}
	...
	*/
	...
	public int deleteCommunitySecondCategoryConfigByIds(String[] ids) {
		return communitySecondCategoryConfigService.deleteCommunitySecondCategoryConfigByIds(ids);
	}
	...
	*/
	...
	public int deleteCommunitySecondCategoryConfigById(String id) {
		return communitySecondCategoryConfigService.deleteCommunitySecondCategoryConfigById(id);
	}
