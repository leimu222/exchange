 ...
 */
@Service
public class MemberDepositBizServiceImpl extends CommonService implements IMemberDepositBizService {
	@Autowired
	...
	*/
	...
	public MemberDeposit selectMemberDepositById(Long id) {
		return memberDepositService.selectMemberDepositById(id);
	}
	...
	*/
	...
	public List<MemberDeposit> selectMemberDepositList(MemberDeposit memberDeposit) {
		return memberDepositService.selectMemberDepositList(memberDeposit);
	}
	...
	*/
	...
	public int insertMemberDeposit(MemberDeposit memberDeposit) {
		return memberDepositService.insertMemberDeposit(memberDeposit);
	}
	...
	*/
	...
	public int updateMemberDeposit(MemberDeposit memberDeposit) {
		return memberDepositService.updateMemberDeposit(memberDeposit);
	}
	...
	*/
	...
	public int deleteMemberDepositByIds(Long[] ids) {
		return memberDepositService.deleteMemberDepositByIds(ids);
	}
	...
	*/
	...
	public int deleteMemberDepositById(Long id) {
		return memberDepositService.deleteMemberDepositById(id);
	}
