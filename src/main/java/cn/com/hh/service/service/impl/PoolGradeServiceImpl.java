 ...
 */
@Service
public class PoolGradeServiceImpl implements IPoolGradeService {
	@Autowired
	private PoolGradeMapper poolGradeMapper;
	...
	*/
	...
	public PoolGrade selectPoolGradeById(Long id) {
		return poolGradeMapper.selectPoolGradeById(id);
	}
	...
	*/
	...
	public List<PoolGrade> selectPoolGradeList(PoolGrade poolGrade) {
		return poolGradeMapper.selectPoolGradeList(poolGrade);
	}
	...
	*/
	...
	public int insertPoolGrade(PoolGrade poolGrade) {
		return poolGradeMapper.insertPoolGrade(poolGrade);
	}
	...
	*/
	...
	public int updatePoolGrade(PoolGrade poolGrade) {
		return poolGradeMapper.updatePoolGrade(poolGrade);
	}
	...
	*/
	...
	public int deletePoolGradeByIds(Long[] ids) {
		return poolGradeMapper.deletePoolGradeByIds(ids);
	}
	...
	*/
	...
	public int deletePoolGradeById(Long id) {
		return poolGradeMapper.deletePoolGradeById(id);
	}
