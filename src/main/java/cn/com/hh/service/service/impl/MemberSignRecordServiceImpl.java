 ...
 */
@Service
public class MemberSignRecordServiceImpl implements IMemberSignRecordService {
	@Autowired
	...
	*/
	...
	public MemberSignRecord selectMemberSignRecordById(Long id) {
		return memberSignRecordMapper.selectMemberSignRecordById(id);
	}
	...
	*/
	...
	public List<MemberSignRecord> selectMemberSignRecordList(MemberSignRecord memberSignRecord) {
		return memberSignRecordMapper.selectMemberSignRecordList(memberSignRecord);
	}
	...
	*/
	...
	public int insertMemberSignRecord(MemberSignRecord memberSignRecord) {
		return memberSignRecordMapper.insertMemberSignRecord(memberSignRecord);
	}
	...
	*/
	...
	public int updateMemberSignRecord(MemberSignRecord memberSignRecord) {
		return memberSignRecordMapper.updateMemberSignRecord(memberSignRecord);
	}
	...
	*/
	...
	public int deleteMemberSignRecordByIds(Long[] ids) {
		return memberSignRecordMapper.deleteMemberSignRecordByIds(ids);
	}
	...
	*/
	...
	public int deleteMemberSignRecordById(Long id) {
		return memberSignRecordMapper.deleteMemberSignRecordById(id);
	}
