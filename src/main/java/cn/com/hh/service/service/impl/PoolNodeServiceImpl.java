 ...
 */
@Service
public class PoolNodeServiceImpl implements IPoolNodeService {
	@Autowired
	...
	*/
	...
	public PoolNode selectPoolNodeById(Long id) {
		return poolNodeMapper.selectPoolNodeById(id);
	}
	...
	*/
	...
	public List<PoolNode> selectPoolNodeList(PoolNode poolNode) {
		return poolNodeMapper.selectPoolNodeList(poolNode);
	}
	...
	*/
	...
	public int insertPoolNode(PoolNode poolNode) {
		return poolNodeMapper.insertPoolNode(poolNode);
	}
	...
	*/
	...
	public int updatePoolNode(PoolNode poolNode) {
		return poolNodeMapper.updatePoolNode(poolNode);
	}
	...
	*/
	...
	public int deletePoolNodeByIds(Long[] ids) {
		return poolNodeMapper.deletePoolNodeByIds(ids);
	}
	...
	*/
	...
	public int deletePoolNodeById(Long id) {
		return poolNodeMapper.deletePoolNodeById(id);
	}
