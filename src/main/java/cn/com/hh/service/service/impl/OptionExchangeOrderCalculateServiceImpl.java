 ...
 */
@Service
public class OptionExchangeOrderCalculateServiceImpl implements IOptionExchangeOrderCalculateService {
	@Autowired
	private OptionExchangeOrderCalculateMapper optionExchangeOrderCalculateMapper;
	...
	*/
	...
	public OptionExchangeOrderCalculate selectOptionExchangeOrderCalculateById(Long orderId) {
		return optionExchangeOrderCalculateMapper.selectOptionExchangeOrderCalculateById(orderId);
	}
	...
	*/
	...
	public List<OptionExchangeOrderCalculate> selectOptionExchangeOrderCalculateList(OptionExchangeOrderCalculate optionExchangeOrderCalculate) {
		return optionExchangeOrderCalculateMapper.selectOptionExchangeOrderCalculateList(optionExchangeOrderCalculate);
	}
	...
	*/
	...
	public int insertOptionExchangeOrderCalculate(OptionExchangeOrderCalculate optionExchangeOrderCalculate) {
		return optionExchangeOrderCalculateMapper.insertOptionExchangeOrderCalculate(optionExchangeOrderCalculate);
	}
	...
	*/
	...
	public int updateOptionExchangeOrderCalculate(OptionExchangeOrderCalculate optionExchangeOrderCalculate) {
		return optionExchangeOrderCalculateMapper.updateOptionExchangeOrderCalculate(optionExchangeOrderCalculate);
	}
	...
	*/
	...
	public int deleteOptionExchangeOrderCalculateByIds(Long[] orderIds) {
		return optionExchangeOrderCalculateMapper.deleteOptionExchangeOrderCalculateByIds(orderIds);
	}
	...
	*/
	...
	public int deleteOptionExchangeOrderCalculateById(Long orderId) {
		return optionExchangeOrderCalculateMapper.deleteOptionExchangeOrderCalculateById(orderId);
	}
