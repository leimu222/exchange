 ...
 */
@Service
public class LeverWalletTransferRecordServiceImpl implements ILeverWalletTransferRecordService {
	@Autowired
	private LeverWalletTransferRecordMapper leverWalletTransferRecordMapper;
	...
	*/
	...
	public LeverWalletTransferRecord selectLeverWalletTransferRecordById(Long id) {
		return leverWalletTransferRecordMapper.selectLeverWalletTransferRecordById(id);
	}
	...
	*/
	...
	public List<LeverWalletTransferRecord> selectLeverWalletTransferRecordList(LeverWalletTransferRecord leverWalletTransferRecord) {
		return leverWalletTransferRecordMapper.selectLeverWalletTransferRecordList(leverWalletTransferRecord);
	}
	...
	*/
	...
	public int insertLeverWalletTransferRecord(LeverWalletTransferRecord leverWalletTransferRecord) {
		return leverWalletTransferRecordMapper.insertLeverWalletTransferRecord(leverWalletTransferRecord);
	}
	...
	*/
	...
	public int updateLeverWalletTransferRecord(LeverWalletTransferRecord leverWalletTransferRecord) {
		return leverWalletTransferRecordMapper.updateLeverWalletTransferRecord(leverWalletTransferRecord);
	}
	...
	*/
	...
	public int deleteLeverWalletTransferRecordByIds(Long[] ids) {
		return leverWalletTransferRecordMapper.deleteLeverWalletTransferRecordByIds(ids);
	}
	...
	*/
	...
	public int deleteLeverWalletTransferRecordById(Long id) {
		return leverWalletTransferRecordMapper.deleteLeverWalletTransferRecordById(id);
	}
