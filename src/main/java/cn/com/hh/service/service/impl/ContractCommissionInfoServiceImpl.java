 ...
 */
@Service
public class ContractCommissionInfoServiceImpl implements IContractCommissionInfoService {
	@Autowired
	private ContractCommissionInfoMapper contractCommissionInfoMapper;
	...
	*/
	...
	public ContractCommissionInfo selectContractCommissionInfoById(Integer id) {
		return contractCommissionInfoMapper.selectContractCommissionInfoById(id);
	}
	...
	*/
	...
	public List<ContractCommissionInfo> selectContractCommissionInfoList(ContractCommissionInfo contractCommissionInfo) {
		return contractCommissionInfoMapper.selectContractCommissionInfoList(contractCommissionInfo);
	}
	...
	*/
	...
	public int insertContractCommissionInfo(ContractCommissionInfo contractCommissionInfo) {
		return contractCommissionInfoMapper.insertContractCommissionInfo(contractCommissionInfo);
	}
	...
	*/
	...
	public int updateContractCommissionInfo(ContractCommissionInfo contractCommissionInfo) {
		return contractCommissionInfoMapper.updateContractCommissionInfo(contractCommissionInfo);
	}
	...
	*/
	...
	public int deleteContractCommissionInfoByIds(Integer[] ids) {
		return contractCommissionInfoMapper.deleteContractCommissionInfoByIds(ids);
	}
	...
	*/
	...
	public int deleteContractCommissionInfoById(Integer id) {
		return contractCommissionInfoMapper.deleteContractCommissionInfoById(id);
	}
